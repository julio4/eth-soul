...
export const TopBanner: FC = () => {
	...
	return (
		<>
			<Link
				href={href}
				tw="top-0 left-0 right-0 z-10 flex items-center justify-center whitespace-pre-wrap border-gray-100 border-b bg-gray-50 py-2 px-2 text-center font-semibold text-sm text-black/75 hover:text-black"
			>

import { Children, cloneElement, isValidElement, useEffect, useRef, useState, ReactNode, useCallback } from 'react'
...
const Map = ({ className, onClick, onIdle, children, onZoomChange, ...options }: MapProps) => {
